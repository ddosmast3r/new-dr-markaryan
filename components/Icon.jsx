...
const paths = {
  ...
  max: <path fill="currentColor" stroke="none" fillRule="evenodd" d="M12 2.6c-5.3 0-9.5 4-9.5 9 0 2 .7 3.9 1.9 5.4l-1.3 4.7 4.9-1.5c1.2.5 2.6.8 4 .8 5.3 0 9.5-4 9.5-9s-4.2-9.4-9.5-9.4Zm0 5.3a3.6 3.6 0 1 0 0 7.2 3.6 3.6 0 0 0 0-7.2Z" />,
  ...
  whatsapp: <><path d="M12 3.3a8.7 8.7 0 00-7.4 13.2L3.3 21l4.7-1.2A8.7 8.7 0 1012 3.3Z" /><path fill="currentColor" stroke="none" d="M9.55 8.05c-.16-.36-.33-.37-.48-.38h-.41c-.14 0-.38.05-.58.27-.2.22-.76.74-.76 1.81s.78 2.1.89 2.24c.11.15 1.51 2.42 3.74 3.3 1.86.74 2.24.6 2.64.56.4-.04 1.3-.53 1.48-1.05.18-.51.18-.95.13-1.05-.05-.1-.2-.15-.41-.26-.22-.11-1.3-.64-1.5-.71-.2-.07-.35-.11-.5.11-.14.22-.56.71-.69.86-.13.15-.25.16-.47.05-.22-.11-.94-.34-1.78-1.1-.66-.59-1.1-1.31-1.23-1.53-.13-.22-.01-.34.1-.45.1-.1.22-.25.32-.38.11-.13.14-.22.22-.37.07-.15.04-.27-.02-.38l-.71-1.85Z" /></>,
