      ...
      <div className="container hero-grid">
        <div className="hero-copy">
          <div className="badge-row">
            <span className="pill"><span className="dot" />Приём проктолога в Пятигорске и Ессентуках</span>
          </div>
          ...
          <h1>Проктолог и хирург-колопроктолог{' '}<br />в Пятигорске и Ессентуках</h1>
          ...
          <p className="lead">
            ...
            хирург&#8209;колопроктолог. Веду приём взрослых пациентов в Пятигорске и Ессентуках
